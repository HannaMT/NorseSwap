...
const HOW_IT_WORKS = [
  {
    ...
    body: 'Sign up with your university email. Every person on CampusLoop is a real, verified student.',
    color: 'bg-blue-500',
  },
  {
    step: '02',
        ...
        <div className="bg-brand-orange rounded-3xl p-12 sm:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 font-body text-lg max-w-md mx-auto mb-8">
              Join thousands of students already buying, renting, and connecting on CampusLoop.
            </p>
            <Link to="/register"
